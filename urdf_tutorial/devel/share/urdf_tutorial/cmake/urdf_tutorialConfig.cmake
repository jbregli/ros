...
if("TRUE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /root/urdf_tutorial/src/urdf_tutorial)
  set(urdf_tutorial_DEVEL_PREFIX /root/urdf_tutorial/devel)
  ...
  set(urdf_tutorial_INSTALL_PREFIX /root/urdf_tutorial/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/urdf_tutorial/src/urdf_tutorial/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>' to fix it.")
    endif()
